          ...
          <form>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                id="birthdate"
                type="date"
                value={newAuthor.birthdate.toLocaleDateString('en-CA')}
                onChange={(e) =>
                  setNewAuthor({
                    ...newAuthor,
                    birthdate: e.target.value ? new Date(e.target.value) : new Date(),
                  })
                }
              />
            </div>
            <div className="mb-4">
              ...
              <input
                ...
                id="deathdate"
                type="date"
                value={newAuthor.deathdate?.toLocaleDateString('en-CA') || ''}
                onChange={(e) =>
                  setNewAuthor({
                    ...newAuthor,
            ...
            <div className="bg-white rounded px-8 pt-6 pb-8 mb-4">
              <div>
                ...
                <input
                  ...
                  id="deathdate"
                  type="date"
                  value={authorToEdit.deathdate && authorToEdit.deathdate.toISOString().substr(0, 10) || ''}
                  onChange={(e) =>
                    setAuthorToEdit({
                      ...authorToEdit,
                      deathdate: e.target.value ? new Date(e.target.value) : undefined,
            ...
            <tbody>
              {authors.map((author) => (
                ...
                >
                  ...
                  <td className="border px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                    {author.deathdate ? new Date(author.deathdate).toLocaleDateString() : '--'}
                  </td>
